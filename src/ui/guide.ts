...
export const VIBRATO_TARGET =
  "Ориентир по референсам: волна около 5.5 Гц с размахом 150 центов и стабильностью темпа ≤ 10 %. Тренируется как барабанная дробь: клик метронома — на каждый 4-й качок волны (5.5 Гц = 82.5, на практике 83 BPM). Встроенный метроном и синусоида-эталон следуют ползунку BPM в тулбаре.";
    ...
    exercises: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Лестница: 60 → 64 → 69 → 72 → 76 → 80 → 83 BPM (шаги 2–5 BPM = +0.15–0.35 Гц). Ползунок BPM в тулбаре задаёт и клик, и синусоиду",
