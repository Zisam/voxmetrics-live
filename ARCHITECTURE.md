...
- Тулбар: Начать/Стоп, селектор канала (C=микс L+R по умолчанию / L / R, выбор сохраняется), гейт (ползунок −90..−20 dB), «?» (руководство), «Эталон» (оверлей), «Метроном», BPM (55–95, дефолт 83 = 5.5 Hz), «Сдвиг» (компенсация латентности голоса, дефолт 120 ms), селектор языка RU/EN/JA
